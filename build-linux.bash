...
PROJECT_NETSNMP_WITH_SIBLING_SSL="${MY_PROJECT_NETSNMP_WITH_SIBLING_SSL:=OFF}"
...
if [ "ON" = "$PROJECT_NETSNMP_WITH_SIBLING_SSL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNETSNMP_WITH_SIBLING_SSL=$PROJECT_NETSNMP_WITH_SIBLING_SSL")
fi
...
echo "[Linux] Project information: Net-SNMP with disabled apps: $PROJECT_NETSNMP_WITH_DISABLED_APPS"
