...
if (HAVE_DLFCN_H)
    check_symbol_exists (dlopen "dlfcn.h" HAVE_DLFCN_H)
endif ()
if (HAVE_UNISTD_H)
...
if (HAVE_UNISTD_H)
    ...
    check_symbol_exists (forkall "unistd.h" HAVE_FORK)
...
if (HAVE_ARPA_INET_H)
    check_symbol_exists (in_addr_t "netinet/in.h" HAVE_NETINET_IN_H)
endif ()
