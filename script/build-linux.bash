...
echo "[$SYSTEM_PLATFORM] Project information: Net-SNMP with disabled apps: $PROJECT_NETSNMP_WITH_DISABLED_APPS"
echo "[$SYSTEM_PLATFORM] Project information: Net-SNMP with disabled MIB loading: $PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING"
echo "[$SYSTEM_PLATFORM] Project information: Net-SNMP with IPv6: $PROJECT_NETSNMP_WITH_IPV6"
echo "[$SYSTEM_PLATFORM] Project information: Net-SNMP with shared libraries: $PROJECT_NETSNMP_WITH_SHARED_LIBRARIES"
echo "[$SYSTEM_PLATFORM] Project information: Net-SNMP with SSL: $PROJECT_NETSNMP_WITH_SSL"
