...
PROJECT_NETSNMP_WITH_DISABLED_APPS="${MY_PROJECT_NETSNMP_WITH_DISABLED_APPS:=OFF}"
PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING="${MY_PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING:=OFF}"
PROJECT_NETSNMP_WITH_IPV6="${MY_PROJECT_NETSNMP_WITH_IPV6:=OFF}"
PROJECT_NETSNMP_WITH_LIBSSH2="${MY_PROJECT_NETSNMP_WITH_LIBSSH2:=OFF}"
...
if [ "ON" = "$PROJECT_NETSNMP_WITH_DISABLED_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNETSNMP_WITH_DISABLED_APPS=$PROJECT_NETSNMP_WITH_DISABLED_APPS")
fi
if [ "ON" = "$PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNETSNMP_WITH_DISABLED_MIB_LOADING=$PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING")
fi
if [ "ON" = "$PROJECT_NETSNMP_WITH_IPV6" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNETSNMP_WITH_IPV6=$PROJECT_NETSNMP_WITH_IPV6")
fi
if [ "ON" = "$PROJECT_NETSNMP_WITH_LIBSSH2" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNETSNMP_WITH_LIBSSH2=$PROJECT_NETSNMP_WITH_LIBSSH2")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: Net-SNMP with disabled apps: $PROJECT_NETSNMP_WITH_DISABLED_APPS"
echo "[$SYSTEM_PLATFORM] Component information: Net-SNMP with disabled MIB loading: $PROJECT_NETSNMP_WITH_DISABLED_MIB_LOADING"
echo "[$SYSTEM_PLATFORM] Component information: Net-SNMP with IPv6: $PROJECT_NETSNMP_WITH_IPV6"
echo "[$SYSTEM_PLATFORM] Component information: Net-SNMP with LibSSH2: $PROJECT_NETSNMP_WITH_LIBSSH2"
